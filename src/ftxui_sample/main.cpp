...
// configuration step. It creates a namespace called `cpplearning`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpplearning::cmake::project_name, cpplearning::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpplearning::cmake::project_version);
      return EXIT_SUCCESS;
    }
